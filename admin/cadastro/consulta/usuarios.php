<?php
    include_once "../controller/select/listaUsuarios.php";
                ...
                <table class="centered">
                    ...
                    <tbody>
                        ...
                        <?php
                                ...
                                while($resUsu = $resultUsu->fetch_assoc()){
                                    ?>
                        <tr>
                            <td><?php echo $resUsu['idusuario'] ?></td>
                            <td><?php echo $resUsu['usuario'] ?></td>
                            <td><?php echo $resUsu['nome'] ?></td>
                            <td><?php echo $resUsu['email'] ?></td>
                            <td><?php echo $resUsu['descricao'] ?></td>
                        </tr>
                        <?php
                                }
                            }
