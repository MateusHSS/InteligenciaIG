<?php
    include_once "../controller/select/listaStatusAtendimento.php";
                ...
                <table class="centered">
                    ...
                    <tbody>
                        ...
                        <?php
                                ...
                                while($resSttsAtend = $resultSttsAtend->fetch_assoc()){
                                    ?>
                        <tr>
                            <td><?php echo $resSttsAtend['idstatusatendimento'] ?></td>
                            <td><?php echo $resSttsAtend['descricao'] ?></td>
                        </tr>
                        <?php
                                }
                            }
