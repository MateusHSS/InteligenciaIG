<?php
    include_once "../controller/select/listaFuncionarios.php";
                ...
                <table class="centered">
                    ...
                    <tbody>
                        ...
                        <?php
                                ...
                                while($resFunc = $resultFunc->fetch_assoc()){
                                    ?>
                        <tr>
                            <td><?php echo $resFunc['idfuncionario'] ?></td>
                            <td><?php echo $resFunc['nome'] ?></td>
                            <td><?php echo $resFunc['email'] ?></td>
                            <td><?php echo $resFunc['descricao'] ?></td>
                        </tr>
                        <?php
                                }
                            }
