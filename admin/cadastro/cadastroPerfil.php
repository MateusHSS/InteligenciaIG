...
<head>
    ...
    <title>IG - Cadastro de perfil</title>
    <!--ICONS-->
...
<body class="has-fixed-sidenav">
    ...
    <main>
        <div class="container">
            ...
            <form action="controller/insert/insereStatusAtendimento.php" method='post' class='center'>
                <div class="row">
                    <div class="input-field col l12">
                        <input id="descricao-perfil" type="text" class="validate" name='descricao-perfil'
