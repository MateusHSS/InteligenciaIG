...
<body class="has-fixed-sidenav">
    ...
    <main>
        <div class="container">
            ...
            <form action="controller/insert/insereUsuario.php" method='post' class='center'>
                <div class="row">
                    ...
                    <div class="input-field col l6">
                        <input id="email" type="email" class="validate" name='user'>
                    ...
                    <div class="input-field col l6">
                        <input id="confirma-senha" type="password" class="validate" name='confirma-senha'>
                    ...
                    <div class="input-field col l6">
                        <select name='perfil' id='perfil'>
                            ...
                            <?php 
                                ...
                                $sqlPerfil = $connect->prepare("SELECT * FROM perfil");
                                $sqlPerfil->execute();
                                $resultPerfil = $sqlPerfil->get_result();

                                while($resPerfil = $resultPerfil->fetch_assoc()){
                                    ?>
                            <option value="<?php echo $resPerfil['idperfil'] ;?>"><?php echo $resPerfil['descricao']?>
                            </option>
                            <?php
                                }
                            ?>
