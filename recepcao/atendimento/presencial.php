...
<body class="has-fixed-sidenav">
    ...
    <main>
        <div class="container center">
            ...
            <form action="controller/insert/insereAtendimentoPresencial.php" method='post' class='center'>
                <div class="input-field col l12">
                    <p>
                        <label>
                            <input class="with-gap" name="tipo_atendimento" value="3" type="radio" />
                ...
                <div class="row">
                    ...
                    <div class="input-field col l6">
                        <input id="fone" type="text" class="validate" name='fone'
                            onkeyup="this.value = this.value.toUpperCase();">
